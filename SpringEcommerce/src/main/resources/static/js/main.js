...
------------------------------ */
    ...
    sliderRange.slider({
        ...
        slide: function(event, ui) {
            ammout.val( ui.values[0].toLocaleString('vi-VN') + " đ" + " -  " + ui.values[1].toLocaleString('vi-VN') + " đ");
            $("#slider-range").trigger('sliderChange', [ui.values]);
        }
    });
    ammout.val(sliderRange.slider("values", 0).toLocaleString('vi-VN') + " đ" + " -  " + sliderRange.slider("values", 1).toLocaleString('vi-VN')+ " đ");
